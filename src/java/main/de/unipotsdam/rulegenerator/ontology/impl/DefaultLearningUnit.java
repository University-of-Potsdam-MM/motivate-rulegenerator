...
public class DefaultLearningUnit extends WrappedIndividualImpl implements LearningUnit {
    ...
    public boolean hasHasMeasurableContextInformation() {
	   return !getHasMeasurableContextInformation().isEmpty();
    }

    public void addHasMeasurableContextInformation(MeasurableContextInformation newHasMeasurableContextInformation) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASMEASURABLECONTEXTINFORMATION,
                                       newHasMeasurableContextInformation);
    }

    public void removeHasMeasurableContextInformation(MeasurableContextInformation oldHasMeasurableContextInformation) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASMEASURABLECONTEXTINFORMATION,
                                          oldHasMeasurableContextInformation);
    }
