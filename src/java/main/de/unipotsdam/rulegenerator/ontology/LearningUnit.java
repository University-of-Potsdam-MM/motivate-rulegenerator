...
public interface LearningUnit extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.motivate-project.de/ontologies/knowledge#hasLearningUnitMetaData
     */
     
    /**
     * Gets all property values for the hasLearningUnitMetaData property.<p>
     * 
     * @returns a collection of values for the hasLearningUnitMetaData property.
     */
    Collection<? extends WrappedIndividual> getHasLearningUnitMetaData();

    /**
     * Checks if the class has a hasLearningUnitMetaData property value.<p>
     * 
     * @return true if there is a hasLearningUnitMetaData property value.
     */
    boolean hasHasLearningUnitMetaData();

    /**
     * Adds a hasLearningUnitMetaData property value.<p>
     * 
     * @param newHasLearningUnitMetaData the hasLearningUnitMetaData property value to be added
     */
    void addHasLearningUnitMetaData(WrappedIndividual newHasLearningUnitMetaData);

    /**
     * Removes a hasLearningUnitMetaData property value.<p>
     * 
     * @param oldHasLearningUnitMetaData the hasLearningUnitMetaData property value to be removed.
     */
    void removeHasLearningUnitMetaData(WrappedIndividual oldHasLearningUnitMetaData);
    ...
    /* ***************************************************
     * Property http://www.motivate-project.de/ontologies/knowledge#hasImageContentMetaData
     */
     
    /**
     * Gets all property values for the hasImageContentMetaData property.<p>
     * 
     * @returns a collection of values for the hasImageContentMetaData property.
     */
    Collection<? extends Boolean> getHasImageContentMetaData();

    /**
     * Checks if the class has a hasImageContentMetaData property value.<p>
     * 
     * @return true if there is a hasImageContentMetaData property value.
     */
    boolean hasHasImageContentMetaData();

    /**
     * Adds a hasImageContentMetaData property value.<p>
     * 
     * @param newHasImageContentMetaData the hasImageContentMetaData property value to be added
     */
    void addHasImageContentMetaData(Boolean newHasImageContentMetaData);

    /**
     * Removes a hasImageContentMetaData property value.<p>
     * 
     * @param oldHasImageContentMetaData the hasImageContentMetaData property value to be removed.
     */
    void removeHasImageContentMetaData(Boolean oldHasImageContentMetaData);
    ...
    /* ***************************************************
     * Property http://www.motivate-project.de/ontologies/knowledge#hasMetaData
     */
     
    /**
     * Gets all property values for the hasMetaData property.<p>
     * 
     * @returns a collection of values for the hasMetaData property.
     */
    Collection<? extends Object> getHasMetaData();

    /**
     * Checks if the class has a hasMetaData property value.<p>
     * 
     * @return true if there is a hasMetaData property value.
     */
    boolean hasHasMetaData();

    /**
     * Adds a hasMetaData property value.<p>
     * 
     * @param newHasMetaData the hasMetaData property value to be added
     */
    void addHasMetaData(Object newHasMetaData);

    /**
     * Removes a hasMetaData property value.<p>
     * 
     * @param oldHasMetaData the hasMetaData property value to be removed.
     */
    void removeHasMetaData(Object oldHasMetaData);
    ...
    /* ***************************************************
     * Property http://www.motivate-project.de/ontologies/knowledge#hasTextualContentMetaData
     */
     
    /**
     * Gets all property values for the hasTextualContentMetaData property.<p>
     * 
     * @returns a collection of values for the hasTextualContentMetaData property.
     */
    Collection<? extends Boolean> getHasTextualContentMetaData();

    /**
     * Checks if the class has a hasTextualContentMetaData property value.<p>
     * 
     * @return true if there is a hasTextualContentMetaData property value.
     */
    boolean hasHasTextualContentMetaData();

    /**
     * Adds a hasTextualContentMetaData property value.<p>
     * 
     * @param newHasTextualContentMetaData the hasTextualContentMetaData property value to be added
     */
    void addHasTextualContentMetaData(Boolean newHasTextualContentMetaData);

    /**
     * Removes a hasTextualContentMetaData property value.<p>
     * 
     * @param oldHasTextualContentMetaData the hasTextualContentMetaData property value to be removed.
     */
    void removeHasTextualContentMetaData(Boolean oldHasTextualContentMetaData);
    ...
    /* ***************************************************
     * Property http://www.motivate-project.de/ontologies/knowledge#hasVideoContentMetaData
     */
     
    /**
     * Gets all property values for the hasVideoContentMetaData property.<p>
     * 
     * @returns a collection of values for the hasVideoContentMetaData property.
     */
    Collection<? extends Boolean> getHasVideoContentMetaData();

    /**
     * Checks if the class has a hasVideoContentMetaData property value.<p>
     * 
     * @return true if there is a hasVideoContentMetaData property value.
     */
    boolean hasHasVideoContentMetaData();

    /**
     * Adds a hasVideoContentMetaData property value.<p>
     * 
     * @param newHasVideoContentMetaData the hasVideoContentMetaData property value to be added
     */
    void addHasVideoContentMetaData(Boolean newHasVideoContentMetaData);

    /**
     * Removes a hasVideoContentMetaData property value.<p>
     * 
     * @param oldHasVideoContentMetaData the hasVideoContentMetaData property value to be removed.
     */
    void removeHasVideoContentMetaData(Boolean oldHasVideoContentMetaData);
