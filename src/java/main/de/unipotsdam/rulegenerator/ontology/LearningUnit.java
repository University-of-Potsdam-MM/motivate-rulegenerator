...
public interface LearningUnit extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/moebert/ontologies/2014/4/untitled-ontology-35#hasMeasurableContextInformation
     */
     
    /**
     * Gets all property values for the hasMeasurableContextInformation property.<p>
     * 
     * @returns a collection of values for the hasMeasurableContextInformation property.
     */
    Collection<? extends MeasurableContextInformation> getHasMeasurableContextInformation();

    /**
     * Checks if the class has a hasMeasurableContextInformation property value.<p>
     * 
     * @return true if there is a hasMeasurableContextInformation property value.
     */
    boolean hasHasMeasurableContextInformation();

    /**
     * Adds a hasMeasurableContextInformation property value.<p>
     * 
     * @param newHasMeasurableContextInformation the hasMeasurableContextInformation property value to be added
     */
    void addHasMeasurableContextInformation(MeasurableContextInformation newHasMeasurableContextInformation);

    /**
     * Removes a hasMeasurableContextInformation property value.<p>
     * 
     * @param oldHasMeasurableContextInformation the hasMeasurableContextInformation property value to be removed.
     */
    void removeHasMeasurableContextInformation(MeasurableContextInformation oldHasMeasurableContextInformation);
    ...
    /* ***************************************************
     * Property http://www.motivate-project.de/ontologies/motivate.owl#hasLearningUnitLogicalOperator
     */
