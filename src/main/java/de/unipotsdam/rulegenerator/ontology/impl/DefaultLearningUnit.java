...
public class DefaultLearningUnit extends WrappedIndividualImpl implements LearningUnit {
    ...
    public Collection<? extends MeasurableContextInformation> getHasLearningUnitMeasurableContextInformation() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASLEARNINGUNITMEASURABLECONTEXTINFORMATION,
                                               DefaultMeasurableContextInformation.class);
    }

    public boolean hasHasLearningUnitMeasurableContextInformation() {
	   return !getHasLearningUnitMeasurableContextInformation().isEmpty();
    }

    public void addHasLearningUnitMeasurableContextInformation(MeasurableContextInformation newHasLearningUnitMeasurableContextInformation) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASLEARNINGUNITMEASURABLECONTEXTINFORMATION,
                                       newHasLearningUnitMeasurableContextInformation);
    }

    public void removeHasLearningUnitMeasurableContextInformation(MeasurableContextInformation oldHasLearningUnitMeasurableContextInformation) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASLEARNINGUNITMEASURABLECONTEXTINFORMATION,
                                          oldHasLearningUnitMeasurableContextInformation);
    }
    ...
    public Collection<? extends WrappedIndividual> getHasLearningUnitMetaData() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASLEARNINGUNITMETADATA,
                                               WrappedIndividualImpl.class);
    }

    public boolean hasHasLearningUnitMetaData() {
	   return !getHasLearningUnitMetaData().isEmpty();
    }

    public void addHasLearningUnitMetaData(WrappedIndividual newHasLearningUnitMetaData) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASLEARNINGUNITMETADATA,
                                       newHasLearningUnitMetaData);
    }

    public void removeHasLearningUnitMetaData(WrappedIndividual oldHasLearningUnitMetaData) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HASLEARNINGUNITMETADATA,
                                          oldHasLearningUnitMetaData);
    }
    ...
    public Collection<? extends Boolean> getHasImageContentMetaData() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASIMAGECONTENTMETADATA, Boolean.class);
    }

    public boolean hasHasImageContentMetaData() {
		return !getHasImageContentMetaData().isEmpty();
    }

    public void addHasImageContentMetaData(Boolean newHasImageContentMetaData) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASIMAGECONTENTMETADATA, newHasImageContentMetaData);
    }

    public void removeHasImageContentMetaData(Boolean oldHasImageContentMetaData) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASIMAGECONTENTMETADATA, oldHasImageContentMetaData);
    }
    ...
    public Collection<? extends Object> getHasLearningUnitLogicalOperator() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASLEARNINGUNITLOGICALOPERATOR, Object.class);
    }

    public boolean hasHasLearningUnitLogicalOperator() {
		return !getHasLearningUnitLogicalOperator().isEmpty();
    }

    public void addHasLearningUnitLogicalOperator(Object newHasLearningUnitLogicalOperator) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASLEARNINGUNITLOGICALOPERATOR, newHasLearningUnitLogicalOperator);
    }

    public void removeHasLearningUnitLogicalOperator(Object oldHasLearningUnitLogicalOperator) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASLEARNINGUNITLOGICALOPERATOR, oldHasLearningUnitLogicalOperator);
    }
    ...
    public Collection<? extends Object> getHasMetaData() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASMETADATA, Object.class);
    }

    public boolean hasHasMetaData() {
		return !getHasMetaData().isEmpty();
    }

    public void addHasMetaData(Object newHasMetaData) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASMETADATA, newHasMetaData);
    }

    public void removeHasMetaData(Object oldHasMetaData) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASMETADATA, oldHasMetaData);
    }
    ...
    public Collection<? extends Boolean> getHasTextualContentMetaData() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTEXTUALCONTENTMETADATA, Boolean.class);
    }

    public boolean hasHasTextualContentMetaData() {
		return !getHasTextualContentMetaData().isEmpty();
    }

    public void addHasTextualContentMetaData(Boolean newHasTextualContentMetaData) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTEXTUALCONTENTMETADATA, newHasTextualContentMetaData);
    }

    public void removeHasTextualContentMetaData(Boolean oldHasTextualContentMetaData) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTEXTUALCONTENTMETADATA, oldHasTextualContentMetaData);
    }
    ...
    public Collection<? extends Boolean> getHasVideoContentMetaData() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASVIDEOCONTENTMETADATA, Boolean.class);
    }

    public boolean hasHasVideoContentMetaData() {
		return !getHasVideoContentMetaData().isEmpty();
    }

    public void addHasVideoContentMetaData(Boolean newHasVideoContentMetaData) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASVIDEOCONTENTMETADATA, newHasVideoContentMetaData);
    }

    public void removeHasVideoContentMetaData(Boolean oldHasVideoContentMetaData) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASVIDEOCONTENTMETADATA, oldHasVideoContentMetaData);
    }
