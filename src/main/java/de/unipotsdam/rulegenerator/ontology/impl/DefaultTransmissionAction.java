 ...
 * Source Class: DefaultTransmissionAction <br>
 * @version generated on Thu Dec 04 13:00:54 CET 2014 by tobias
 */
public class DefaultTransmissionAction extends WrappedIndividualImpl implements TransmissionAction {

    public DefaultTransmissionAction(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
