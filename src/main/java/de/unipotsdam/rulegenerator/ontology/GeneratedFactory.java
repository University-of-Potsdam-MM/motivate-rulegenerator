...
public class GeneratedFactory implements CodeGenerationFactory {
    ...
    {
        javaMapping.add("http://www.motivate-project.de/ontologies/knowledge#FeatureConstraint", FeatureConstraint.class, DefaultFeatureConstraint.class);
    }

    /**
     * Creates an instance of type FeatureConstraint.  Modifies the underlying ontology.
     */
    public FeatureConstraint createFeatureConstraint(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_FEATURECONSTRAINT, DefaultFeatureConstraint.class);
    }

    /**
     * Gets an instance of type FeatureConstraint with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public FeatureConstraint getFeatureConstraint(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_FEATURECONSTRAINT, DefaultFeatureConstraint.class);
    }

    /**
     * Gets all instances of FeatureConstraint from the ontology.
     */
    public Collection<? extends FeatureConstraint> getAllFeatureConstraintInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_FEATURECONSTRAINT, DefaultFeatureConstraint.class);
    }
    ...
    {
        javaMapping.add("http://www.motivate-project.de/ontologies/knowledge#LearningUnitConstraint", LearningUnitConstraint.class, DefaultLearningUnitConstraint.class);
    }

    /**
     * Creates an instance of type LearningUnitConstraint.  Modifies the underlying ontology.
     */
    public LearningUnitConstraint createLearningUnitConstraint(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_LEARNINGUNITCONSTRAINT, DefaultLearningUnitConstraint.class);
    }

    /**
     * Gets an instance of type LearningUnitConstraint with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public LearningUnitConstraint getLearningUnitConstraint(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_LEARNINGUNITCONSTRAINT, DefaultLearningUnitConstraint.class);
    }

    /**
     * Gets all instances of LearningUnitConstraint from the ontology.
     */
    public Collection<? extends LearningUnitConstraint> getAllLearningUnitConstraintInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_LEARNINGUNITCONSTRAINT, DefaultLearningUnitConstraint.class);
    }
    ...
    {
        javaMapping.add("http://www.motivate-project.de/ontologies/knowledge#MetaDataConstraintRequirement", MetaDataConstraintRequirement.class, DefaultMetaDataConstraintRequirement.class);
    }

    /**
     * Creates an instance of type MetaDataConstraintRequirement.  Modifies the underlying ontology.
     */
    public MetaDataConstraintRequirement createMetaDataConstraintRequirement(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_METADATACONSTRAINTREQUIREMENT, DefaultMetaDataConstraintRequirement.class);
    }

    /**
     * Gets an instance of type MetaDataConstraintRequirement with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public MetaDataConstraintRequirement getMetaDataConstraintRequirement(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_METADATACONSTRAINTREQUIREMENT, DefaultMetaDataConstraintRequirement.class);
    }

    /**
     * Gets all instances of MetaDataConstraintRequirement from the ontology.
     */
    public Collection<? extends MetaDataConstraintRequirement> getAllMetaDataConstraintRequirementInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_METADATACONSTRAINTREQUIREMENT, DefaultMetaDataConstraintRequirement.class);
    }
