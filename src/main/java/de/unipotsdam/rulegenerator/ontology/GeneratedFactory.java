...
public class GeneratedFactory implements CodeGenerationFactory {
    ...
    {
        javaMapping.add("http://www.motivate-project.de/ontologies/knowledge#ScreenReaderSuitableMetaData", ScreenReaderSuitableMetaData.class, DefaultScreenReaderSuitableMetaData.class);
    }
