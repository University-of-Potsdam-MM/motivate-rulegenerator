 ...
 * @version generated on Mon Feb 09 10:27:04 CET 2015 by tobias
 */
public class GeneratedFactory implements CodeGenerationFactory {
    ...
    {
        javaMapping.add("http://motivate-project.de/ontology/knowledge.owl#Action", Action.class, DefaultAction.class);
    }
    ...
    {
        javaMapping.add("http://motivate-project.de/ontology/knowledge.owl#CancelAction", CancelAction.class, DefaultCancelAction.class);
    }

    /**
     * Creates an instance of type CancelAction.  Modifies the underlying ontology.
     */
    public CancelAction createCancelAction(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_CANCELACTION, DefaultCancelAction.class);
    }

    /**
     * Gets an instance of type CancelAction with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public CancelAction getCancelAction(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_CANCELACTION, DefaultCancelAction.class);
    }

    /**
     * Gets all instances of CancelAction from the ontology.
     */
    public Collection<? extends CancelAction> getAllCancelActionInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_CANCELACTION, DefaultCancelAction.class);
    }
    ...
    {
        javaMapping.add("http://motivate-project.de/ontology/knowledge.owl#FinishAction", FinishAction.class, DefaultFinishAction.class);
    }

    /**
     * Creates an instance of type FinishAction.  Modifies the underlying ontology.
     */
    public FinishAction createFinishAction(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_FINISHACTION, DefaultFinishAction.class);
    }

    /**
     * Gets an instance of type FinishAction with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public FinishAction getFinishAction(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_FINISHACTION, DefaultFinishAction.class);
    }

    /**
     * Gets all instances of FinishAction from the ontology.
     */
    public Collection<? extends FinishAction> getAllFinishActionInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_FINISHACTION, DefaultFinishAction.class);
    }
    ...
    {
        javaMapping.add("http://motivate-project.de/ontology/knowledge.owl#PauseAction", PauseAction.class, DefaultPauseAction.class);
    }

    /**
     * Creates an instance of type PauseAction.  Modifies the underlying ontology.
     */
    public PauseAction createPauseAction(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_PAUSEACTION, DefaultPauseAction.class);
    }

    /**
     * Gets an instance of type PauseAction with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public PauseAction getPauseAction(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_PAUSEACTION, DefaultPauseAction.class);
    }

    /**
     * Gets all instances of PauseAction from the ontology.
     */
    public Collection<? extends PauseAction> getAllPauseActionInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_PAUSEACTION, DefaultPauseAction.class);
    }
    ...
    {
        javaMapping.add("http://motivate-project.de/ontology/knowledge.owl#StartAction", StartAction.class, DefaultStartAction.class);
    }

    /**
     * Creates an instance of type StartAction.  Modifies the underlying ontology.
     */
    public StartAction createStartAction(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_STARTACTION, DefaultStartAction.class);
    }

    /**
     * Gets an instance of type StartAction with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public StartAction getStartAction(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_STARTACTION, DefaultStartAction.class);
    }

    /**
     * Gets all instances of StartAction from the ontology.
     */
    public Collection<? extends StartAction> getAllStartActionInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_STARTACTION, DefaultStartAction.class);
    }
    ...
    {
        javaMapping.add("http://motivate-project.de/ontology/knowledge.owl#TransmissionAction", TransmissionAction.class, DefaultTransmissionAction.class);
    }

    /**
     * Creates an instance of type TransmissionAction.  Modifies the underlying ontology.
     */
    public TransmissionAction createTransmissionAction(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_TRANSMISSIONACTION, DefaultTransmissionAction.class);
    }

    /**
     * Gets an instance of type TransmissionAction with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public TransmissionAction getTransmissionAction(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_TRANSMISSIONACTION, DefaultTransmissionAction.class);
    }

    /**
     * Gets all instances of TransmissionAction from the ontology.
     */
    public Collection<? extends TransmissionAction> getAllTransmissionActionInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_TRANSMISSIONACTION, DefaultTransmissionAction.class);
    }
